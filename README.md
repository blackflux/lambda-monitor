...
First create a new project in Rollbar and call it "lambda-monitor" or similar. Now create a server write key for each stage that you are using and put it into the corresponding `STAGE.yml` file (see above).
